...
function agent_model = i_a_repeat_4_complex(environment_model, config)
  ...
  a_loc         = [ 20, 20;   
                    21, 20;
                    20, 21;
                    21, 21];          % Current locations of UAVs
  ...
  a_battery_level_i = 4e8.*ones(n_a, 1); % Fully charged battery level (s)
