...
function agent_model = i_a_repeat_1(environment_model)
  ...
  % Agent parameters
  n_a           = 1;                % Number of UAVs in simulation
  ...
  a_loc         = [ 1, 1];          % Current locations of UAVs
  a_loc_hist    = [];
  for a = 1:n_a
  ...
  a_battery_level_i = [4e4]; % Fully charged battery level (s)
