...
% TODO
% - CHECK m_scan is input to FIS!
% - check if configurable objective affects FIS performance
% - define config in initialization and add to function calls
% - update function to make m_bo optional
...
%     NOTE: removed - keep using agent maps for objective function
