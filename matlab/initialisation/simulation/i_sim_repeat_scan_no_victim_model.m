...
function config = i_sim_repeat_scan_no_victim_model()
...
weight = struct();
weight.dw = 1e-8;      % Weight for victims
weight.fire = 1e-8;      % Weight for victims
weight.first_scan = 1e-8;   % Weight for the first-time scan. WARNING: IF 0, AGENT BEHAVIOUR COMPROMISED (will re-scan starting cells continuously)
