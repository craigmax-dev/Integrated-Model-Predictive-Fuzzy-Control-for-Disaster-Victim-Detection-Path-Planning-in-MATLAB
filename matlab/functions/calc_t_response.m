...
% function t_travel = calc_t_trav_vectorized(loc_1, loc_2, l_x_s, l_y_s, ang_w, v_w, v_as)
%     % Vectorized calculation of travel time based on your model's specifics
%     % This function should calculate the travel time between two locations considering wind speed, agent speed, etc.
%     % ...
% end
