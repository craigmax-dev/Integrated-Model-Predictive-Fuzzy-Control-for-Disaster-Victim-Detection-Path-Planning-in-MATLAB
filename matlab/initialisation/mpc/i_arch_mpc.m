...
function mpc_model = i_arch_mpc(fisArray, agent_model)
  ...
  solver = 'ga'; % Options: fmincon, ga, particleswarm, patternsearch
  ...
  options_subsequentEval = optimoptions(solver, 'Display', 'iter', 'PopulationSize', 500, 'MaxGenerations', 100, 'UseParallel', true);

  % Specify which variables are integers (all in this case)
  intCon = 1:numel(ini_params);
