    ...
    for q = 2:agent_model.n_q
      ...
      m_t_response = calc_t_response(...
        ...
        for a = 1:agent_model.n_a
            ...
            % agent_model.a_target = func_taskAssignment(q, agent_model.a_target, m_att, config.communication_enabled);            
            % agent_model.a_target(:, :, q) = func_taskAssignment(q, agent_model.a_target, m_att);            
