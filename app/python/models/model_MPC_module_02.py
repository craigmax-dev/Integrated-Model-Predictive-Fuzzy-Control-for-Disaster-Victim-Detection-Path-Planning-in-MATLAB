...
def model_MPC_module_02(fisArray, ini_params, fis_param_hist, solver, options, n_a, n_MF_out,
                        nvars, A, b, Aeq, beq, lb, ub, nonlcon, test_fis_sensitivity, 
                        m_f, m_bo, m_bt, m_prior, m_s, m_scan, m_t_scan, dk_a, dk_c, dk_e, dk_mpc, 
                        dt_s, k, seed, n_p, n_x_s, n_y_s, n_x_e, n_y_e, n_q, a_loc, a_target, 
    ...
    h_MPC = lambda params: func_MPC_model(params, fisArray, test_fis_sensitivity, 
                                         ...
                                         dk_a, dk_c, dk_e, dk_mpc, dt_s, k, seed, n_a, n_MF_out, 
                                         n_p, n_x_s, n_y_s, n_x_e, n_y_e, n_q, a_loc, a_target, 
    ...
    for a in range(n_a):
        for mf in range(n_MF_out):
            ...
            fisArray[a].outputs.membership_functions[mf].parameters = fis_params
            range += 4

    # Record new parameters
    fis_param_hist.append(mpc_params[0:n_a*n_MF_out*4])
