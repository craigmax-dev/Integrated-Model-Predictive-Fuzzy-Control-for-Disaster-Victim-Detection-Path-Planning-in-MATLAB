...
% n_funceval = 100
h_init_MPC_maxfunceval_4 = @(fisArray, n_a)initialise_MPC_maxfunceval_04(fisArray, n_a);
...
plots_simSet = {
  ...
  "obj_hist", "relative", false;
  "s_obj_hist", "variable", false;
  "s_obj_hist", "relative", false;
...
%   close all;
%   
%   for fig = 1:size(plots_simSet,1)
%     data_name = plots_simSet{fig, 1};
% 
